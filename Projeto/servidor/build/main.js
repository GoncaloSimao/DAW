...
const Logins = __importStar(require("./login"));
const app = (0, express_1.default)();
app.use(express_1.default.json());
app.use("/", express_1.default.static(path_1.default.join(__dirname, "../../cliente/dist")));
...
//agora o listContacts recebe uma string como atributo
app.get("/contacts", (inRequest, inResponse) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const contactsWorker = new Contacts.Worker();
        const contacts = yield contactsWorker.listContacts(inRequest.query.owner);
...
//middleware para receber os dados do login do cliente e alterar no server info atraves da funcao alterarserverinfo
app.post("/doLogin", (inRequest, inResponse) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(inRequest.body);
        const maybeUser = Logins.alterarServerInfo(inRequest.body);
        inResponse.json(maybeUser);
    }
    catch (inError) {
        inResponse.send("error");
    }
